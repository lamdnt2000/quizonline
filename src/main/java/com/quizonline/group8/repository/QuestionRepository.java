...
public interface QuestionRepository extends PagingAndSortingRepository<Question,Long> {
    ...
    List<Question> findByQuestionTitleContainingAndSubjectAndStatusOrderByDateCreateDesc(String questionTitle, Subject subject_id, Integer status, Pageable pageable);
